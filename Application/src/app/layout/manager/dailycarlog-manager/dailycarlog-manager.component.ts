...
@Component({
  selector: 'app-dailycarlog-manager',
  templateUrl: './dailycarlog-manager.component.html',
  styleUrls: ['./dailycarlog-manager.component.scss'],
  animations: [routerTransition()],
  providers: [CustomNgbDateParserFormatter]
})
export class DailycarlogManagerComponent implements OnInit {
