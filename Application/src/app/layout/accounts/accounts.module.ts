...
@NgModule({
    imports: [CommonModule, FormsModule, ReactiveFormsModule, PTableModule, AlertModule, HttpModule,
        NgbModule.forRoot(), PageHeaderModule, RouterModule.forChild(routes)],
    declarations: [AccountsComponent, PayslipListComponent, PayslipBookComponent,
        DailyPaymentLogComponent, PayslipDetailsComponent, DailyPaymentDetailsComponent, PayslipBookDetailsComponent,
        TripSheetComponent, VoucherComponent, VoucherDetailsComponent, ChartOfAccountsComponent, CoaDetailsComponent],
