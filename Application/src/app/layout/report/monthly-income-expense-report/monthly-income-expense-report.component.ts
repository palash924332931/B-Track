...
@Component({
  selector: 'app-monthly-income-expense-report',
  templateUrl: './monthly-income-expense-report.component.html',
  styleUrls: ['./monthly-income-expense-report.component.scss'],
  animations: [routerTransition()],
  providers: [CustomNgbDateParserFormatter]
})
export class MonthlyIncomeExpenseReportComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.monthlyIncomeReport.tableName = this.LT == 'bn' ? this.fromDate + ' থেকে ' + this.toDate + ' তারিখের আয় ব্যয়ের প্রতিবেদন' : 'Income Expense Report ' + this.fromDate + ' to ' + this.toDate,
  ...
  fnGetDailyPayment() {
    ...
    this.reportService.fnGetIncomeExpenseReport(this.UserId, this.fromDate, this.toDate, 'All').subscribe(
  ...
  public monthlyIncomeReport = {
    ...
    tableName: this.LT == 'bn' ? this.configService.getCurrentDate() + ' মাসিক আয়ের প্রতিবেদন' : 'Payment Status of Date ' + this.configService.getCurrentDate(),
    tableRowIDInternalName: "CarTypeId",
    tableColDef: [
      { headerName: this.LT == 'bn' ? 'তারিখ' : 'Date ', width: '8%', internalName: 'CheckInDate', sort: true, type: "" },
      //{ headerName: this.LT == 'bn' ? 'গাড়ির বিবরণ' : 'Description', width: '8%', internalName: 'Description', sort: true, type: "" },
      { headerName: this.LT == 'bn' ? 'চলমান গাড়ির সংখ্যা' : 'Number Active of Buses', width: '8%', internalName: 'NumberOfBus', sort: true, type: "button", onClick: "Yes", showTotal: true },
      { headerName: this.LT == 'bn' ? 'মোট কিঃমিঃ' : 'Total Distance (KM)', width: '10%', internalName: 'TotalDistance', sort: true, type: "button", onClick: "Yes", showTotal: true },
      { headerName: this.LT == 'bn' ? 'রুটে রাজস্ব' : 'Route Income', width: '11%', internalName: 'OnRouteIncome', sort: true, type: "button", onClick: "Yes",showTotal: true },
      ...
      { headerName: this.LT == 'bn' ? 'স্টাফ বাসে রাজস্ব' : 'Staff Bus Income (TK)', width: '10%', internalName: 'StaffBusIncome', sort: true, type: "button", onClick: "Yes", showTotal: true },
      { headerName: this.LT == 'bn' ? 'হ্যান্ড সেল' : 'Diff. Route Income', width: '8%', internalName: 'DifferentRouteIncome', sort: true, type: "button", onClick: "Yes", showTotal: true },
      { headerName: this.LT == 'bn' ? 'মোট আয়' : 'Total Income', width: '10%', internalName: 'TotalIncome', sort: true, type: "button", onClick: "Yes", showTotal: true },
      { headerName: this.LT == 'bn' ? 'জ্বালানি খরচ' : 'POL Cost', width: '10%', internalName: 'POLCost', sort: true, type: "button", onClick: "Yes", showTotal: true },
      { headerName: this.LT == 'bn' ? 'আদায়কৃত রাজস্ব' : 'Received Income (TK)', width: '10%', internalName: 'ReceivedAmount', sort: true, type: "button", onClick: "Yes", showTotal: true },
      { headerName: this.LT == 'bn' ? 'অনাদায়ী রাজস্ব' : 'Due Income (TK)', width: '10%', internalName: 'DueAmount', sort: true, type: "button", onClick: "Yes", showTotal: true },
